...
```{r echo=FALSE, out.width="25%", fig.align="center",fig.cap="The cover shows all 284 exercises in in 20 chapters."}
knitr::include_graphics("/img/advrs_cover.png", error = FALSE)
```
